...
window.webcam = {
	...
	swf_url: 'http://'+location.host+'/includes/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://'+location.host+'/includes/js/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'http://'+location.host+'/includes/js/shutter.mp3';
	},
